...
import com.asrtu.jasper.dynamicjasper.DebitReportLayout;
 ...
 */
@Service("debitDownloadService")
@Transactional
public class DebitDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		DebitReportLayout layout = new DebitReportLayout();
		...
		String fileName = "DebitReport.xls";
