...
import com.asrtu.jasper.dynamicjasper.RebateReportLayout;
import com.asrtu.jasper.dynamicjasper.StuTransactionReportLayout;
 ...
 */
@Service("rebateDownloadService")
@Transactional
public class RebateDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		RebateReportLayout layout = new RebateReportLayout();
		...
		String fileName = "RebateReport.xls";
