 ...
 */
@Service("testingChargeDownloadService")
@Transactional
public class TestingChargeDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		TestingChargeReportLayout layout = new TestingChargeReportLayout();
		...
		String fileName = "TestingChargeReport.xls";
