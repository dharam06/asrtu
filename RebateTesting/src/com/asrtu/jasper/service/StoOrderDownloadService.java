...
import com.asrtu.jasper.dynamicjasper.StoOrderReportLayout;
 ...
 */
@Service("stoOrderDownloadService")
@Transactional
public class StoOrderDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StoOrderReportLayout layout = new StoOrderReportLayout();
		...
		String fileName = "StoOrderReport.xls";
