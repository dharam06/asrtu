 ...
 */
@Service("vendorTransactionDownloadService")
@Transactional
public class VendorTransactionDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		VendorTransactionReportLayout layout = new VendorTransactionReportLayout();
		...
		String fileName = "VendorTransactionReport.xls";
