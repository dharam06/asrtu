...
import com.asrtu.jasper.dynamicjasper.CirtReportLayout;
import com.asrtu.jasper.dynamicjasper.RcTrcReportLayout;
import com.asrtu.jasper.dynamicjasper.TestingChargeReportLayout;
import com.asrtu.jasper.dynamicjasper.VendorTransactionReportLayout;
 ...
 */
@Service("rcTrcDownloadService")
@Transactional
public class RcTrcDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		System.out.println("create the Report layout object");
		
		RcTrcReportLayout layout = new RcTrcReportLayout();
		System.out.println("call the Dynamic Report object");
		...
		System.out.println("create the Jasper Report object");
		...
		String fileName = "RcTrcReport.xls";
