...
import com.asrtu.jasper.dynamicjasper.CirtPdfReportLayout;
import com.asrtu.jasper.dynamicjasper.RcTrcPdfReportLayout;
import com.asrtu.jasper.dynamicjasper.TestingChargePdfReportLayout;
import com.asrtu.jasper.dynamicjasper.VendorTransactionPdfReportLayout;
 ...
 */
@Service("rcTrcPdfDownloadService")
@Transactional
public class RcTrcPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		RcTrcPdfReportLayout layout = new RcTrcPdfReportLayout();
		...
		String fileName = "RcTrcReport.pdf";
