...
import com.asrtu.jasper.dynamicjasper.DebitPdfReportLayout;
 ...
 */
@Service("debitPdfDownloadService")
@Transactional
public class DebitPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		DebitPdfReportLayout layout = new DebitPdfReportLayout();
		...
		String fileName = "DebitReport.pdf";
