 ...
 */
@Service("cirtBillPdfDownloadService")
@Transactional
public class CirtBillPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		CirtPdfReportLayout layout = new CirtPdfReportLayout();
		...
		String fileName = "CIRTReport.pdf";
