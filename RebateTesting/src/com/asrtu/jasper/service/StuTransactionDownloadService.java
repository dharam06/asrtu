 ...
 */
@Service("stuTransactionDownloadService")
@Transactional
public class StuTransactionDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StuTransactionReportLayout layout = new StuTransactionReportLayout();
		...
		String fileName = "StuTransactionReport.xls";
