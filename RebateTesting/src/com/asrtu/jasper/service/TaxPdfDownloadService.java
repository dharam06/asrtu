...
import com.asrtu.jasper.dynamicjasper.TaxPdfReportLayout;
 ...
 */
@Service("taxPdfDownloadService")
@Transactional
public class TaxPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		TaxPdfReportLayout layout = new TaxPdfReportLayout();
