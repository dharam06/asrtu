...
import com.asrtu.jasper.dynamicjasper.RebatePdfReportLayout;
import com.asrtu.jasper.dynamicjasper.StuTransactionPdfReportLayout;
 ...
 */
@Service("rebatePdfDownloadService")
@Transactional
public class RebatePdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		RebatePdfReportLayout layout = new RebatePdfReportLayout();
		...
		String fileName = "RebateReport.pdf";
