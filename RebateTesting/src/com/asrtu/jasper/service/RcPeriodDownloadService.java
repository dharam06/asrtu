...
import com.asrtu.jasper.dynamicjasper.ItemMasterReportLayout;
import com.asrtu.jasper.dynamicjasper.RcPeriodReportLayout;
import com.asrtu.jasper.dynamicjasper.StuMasterReportLayout;
 ...
 */
@Service("rcPeriodDownloadService")
@Transactional
public class RcPeriodDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		RcPeriodReportLayout layout = new RcPeriodReportLayout();
		...
		String fileName = "RcPeriodReport.xls";
