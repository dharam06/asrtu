 ...
 */
@Service("testingChargePdfDownloadService")
@Transactional
public class TestingChargePdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		TestingChargePdfReportLayout layout = new TestingChargePdfReportLayout();
		...
		String fileName = "TestingChargeReport.pdf";
