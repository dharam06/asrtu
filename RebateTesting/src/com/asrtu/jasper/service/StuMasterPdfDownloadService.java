 ...
 */
@Service("stuMasterPdfDownloadService")
@Transactional
public class StuMasterPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StuMasterPdfReportLayout layout = new StuMasterPdfReportLayout();
		...
		String fileName = "StuMasterReport.pdf";
