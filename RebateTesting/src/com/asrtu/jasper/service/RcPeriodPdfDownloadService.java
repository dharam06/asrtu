...
import com.asrtu.jasper.dynamicjasper.RcPeriodPdfReportLayout;
 ...
 */
@Service("rcPeriodPdfDownloadService")
@Transactional
public class RcPeriodPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		RcPeriodPdfReportLayout layout = new RcPeriodPdfReportLayout();
		...
		String fileName = "RcPeriodReport.pdf";
