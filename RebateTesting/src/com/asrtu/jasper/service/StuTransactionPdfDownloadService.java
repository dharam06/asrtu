 ...
 */
@Service("stuTransactionPdfDownloadService")
@Transactional
public class StuTransactionPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StuTransactionPdfReportLayout layout = new StuTransactionPdfReportLayout();
		...
		String fileName = "StuTransactionReport.pdf";
