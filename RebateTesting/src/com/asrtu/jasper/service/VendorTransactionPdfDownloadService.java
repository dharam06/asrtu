 ...
 */
@Service("vendorTransactionPdfDownloadService")
@Transactional
public class VendorTransactionPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		VendorTransactionPdfReportLayout layout = new VendorTransactionPdfReportLayout();
		...
		String fileName = "VendorTransactionReport.pdf";
