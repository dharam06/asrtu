...
import com.asrtu.jasper.dynamicjasper.StoOrderPdfReportLayout;
 ...
 */
@Service("stoOrderPdfDownloadService")
@Transactional
public class StoOrderPdfDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StoOrderPdfReportLayout layout = new StoOrderPdfReportLayout();
		...
		String fileName = "StoOrderReport.pdf";
