 ...
 */
@Service("stuMasterDownloadService")
@Transactional
public class StuMasterDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		StuMasterReportLayout layout = new StuMasterReportLayout();
		...
		String fileName = "StuMasterReport.xls";
