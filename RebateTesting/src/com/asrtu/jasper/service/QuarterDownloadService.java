...
import com.asrtu.jasper.dynamicjasper.QuarterReportLayout;
 ...
 */
@Service("quarterDownloadService")
@Transactional
public class QuarterDownloadService {
	...
	public void downloadXLS(HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException {
		...
		QuarterReportLayout layout = new QuarterReportLayout();
		...
		String fileName = "QuarterReport.xls";
