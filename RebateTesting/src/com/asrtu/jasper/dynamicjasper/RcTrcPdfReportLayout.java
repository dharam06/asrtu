 ...
 */
public class RcTrcPdfReportLayout {
	...
	public DynamicReport buildReportLayout() throws ColumnBuilderException, ClassNotFoundException {
		...
		.addColumn("Clear Date", "clearDate" , String.class.getName(), 50)
		.addColumn("From Date", "fromDate" , String.class.getName(), 50)
		...
		// Set the name of the file
		 drb.setReportName("RCTRC Report");
        
		 String hqlQuery="FROM RcTrc ";
