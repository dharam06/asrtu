 ...
 */
public class RebatePdfReportLayout {
	...
	public DynamicReport buildReportLayout() throws ColumnBuilderException, ClassNotFoundException {
		...
		drb.addColumn("Receipt No", "receiptNo",  Integer.class.getName(), 50)
		.addColumn("Payment Type", "paymentType",  String.class.getName(), 50)
		.addColumn("Receipt Date", "receiptDate", String.class.getName(), 50)
		.addColumn("Vendor Code", "vendorCode", String.class.getName(), 50)
		.addColumn("Item Code", "itemCode" , String.class.getName(), 50)
		.addColumn("Quatar From Date", "qfdate", String.class.getName(), 50)
		.addColumn("Quatar to Date", "qtdate", String.class.getName(), 50)
		.addColumn("Cheque No", "chequeNo", String.class.getName(), 50)
		.addColumn("Cheque Date", "chequeDate", String.class.getName(), 50)
        .addColumn("Bank Name", "bankName", String.class.getName(), 50)
        .addColumn("Bank Charge", "bankcharge" , Integer.class.getName(), 50)
        .addColumn("Amount", "amount" , Integer.class.getName(), 50)
        .addColumn("Rebate Amount", "rebAmount" , Integer.class.getName(), 50)
        .addColumn("STMT Amount", "stAmount" , Integer.class.getName(), 50)
        .addColumn("ST Amount", "stmtAmount" , Integer.class.getName(), 50)
        .addColumn("TDS Amount", "tdsAmount", Integer.class.getName(), 50)
        .addColumn("Incentive Amount", "incAmount", Integer.class.getName(), 50)
        .addColumn("EMD Amount", "emdAmount", Integer.class.getName(), 50)
        .addColumn("Rebate Paid Amount", "rebPaidAmount", Integer.class.getName(), 50)
        .addColumn("INT Service Tax Amount", "intServTaxAmount", Integer.class.getName(), 50)
        .addColumn("Balance INTST Amount", "balintStAmount", Integer.class.getName(), 50)
        .addColumn("Balance Rebate Amount", "balRebateAmount", Integer.class.getName(), 50)
        .addColumn("Balance ST Amount", "balStAmount", Integer.class.getName(), 50)
        .addColumn("Total Balance Amount", "totalBalAmount", Integer.class.getName(), 50)
        ...
        drb.setReportName("Rebate Report");
        
        String hqlQuery="FROM RebateForm ";
