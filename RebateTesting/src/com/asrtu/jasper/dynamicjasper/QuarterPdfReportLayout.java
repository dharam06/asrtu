 ...
 */
public class QuarterPdfReportLayout {
	...
	public DynamicReport buildReportLayout() throws ColumnBuilderException, ClassNotFoundException {
		...
		drb.addColumn("S.No.", "slNo",  Integer.class.getName(), 50)
		.addColumn("Name", "quarter", String.class.getName(), 50)
        .addColumn("From Date", "qFrom", String.class.getName(), 50)
        .addColumn("To Date", "qtDate" , String.class.getName(), 50)
        ...
        drb.setReportName("Quarter Report");
        
        String hqlQuery="FROM Quarter ";
