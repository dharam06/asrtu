 ...
 */
public class TaxPdfReportLayout {
	...
	public DynamicReport buildReportLayout() throws ColumnBuilderException, ClassNotFoundException {
		...
		.addColumn("Tax(%)", "taxPercent",  Integer.class.getName(), 50)
		.addColumn("Receipt Date", "fromDate",  String.class.getName(), 50)
		.addColumn("Vendor Code", "toDate", String.class.getName(), 50)
		...
		// Set the name of the file
		 drb.setReportName("Tax Report");
        
		 String hqlQuery="FROM TaxEntry  ";
