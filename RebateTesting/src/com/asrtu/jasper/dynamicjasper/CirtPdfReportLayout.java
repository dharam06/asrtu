 ...
 */
public class CirtPdfReportLayout {
	...
	public DynamicReport buildReportLayout() throws ColumnBuilderException, ClassNotFoundException {
		...
		drb.addColumn("Transaction Id", "transId",  Integer.class.getName(), 50)
		.addColumn("Bill No.", "billNo",  Integer.class.getName(), 50)
		.addColumn("Bill Date", "billDate",  String.class.getName(), 50)
		.addColumn("Bill Amount", "billAmount",  Integer.class.getName(), 50)
		.addColumn("ASRTU Ref. No.", "asrtRefNo" , Integer.class.getName(), 50)
		...
		.addColumn("STU No.", "stuNo" , Integer.class.getName(), 50)
		...
		// Set the name of the file
		 drb.setReportName("CIRT Bill Report");
        
		 String hqlQuery="FROM CirtBill ";
