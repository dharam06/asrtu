...
public class TestingChargeStatementPdf {
	...
	public static Document createPDF(String file, List<TestingChargeBean> testingChargeBean) {
		...
		try {
			...
			document.add( Chunk.NEWLINE );
	        document.add( Chunk.NEWLINE );
			createTable(document, testingChargeBean);
			document.add( Chunk.NEWLINE );
	        document.add( Chunk.NEWLINE );
			document.add( Chunk.NEWLINE );
	        document.add( Chunk.NEWLINE );
...
private static void createFooter(Document document) throws DocumentException  {
	...
	private static void createTable(Document document, List<TestingChargeBean> testingChargeBeanList) throws DocumentException {
		...
		c1 = new PdfPCell(new Phrase("Total Testing Charge Received", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase("Service Tax %", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);

		
		c1 = new PdfPCell(new Phrase("Service Tax Amount", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase("Net Testing Charge", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);

		c1 = new PdfPCell(new Phrase("Bank Name", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase("DD/Chq No", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase("DD/Chq Date", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase("DD Amount", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(c1);
		
		Iterator<TestingChargeBean> itr = testingChargeBeanList.iterator();
		TestingChargeBean rb = null;
		Float totalTestChargeAmount = 0f;
		Float totalServiceTaxAmount = 0f;
		Float totalNetTestingCharge = 0f;
		...
		for (int i=1; itr.hasNext(); i++){
			...
			c1 = new PdfPCell(new Phrase(rb.getReceiptDateString(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase(""+rb.getReceiptNo(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			...
			c1 = new PdfPCell(new Phrase(""+rb.getServiceTax(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table.addCell(c1);		
			
			c1 = new PdfPCell(new Phrase(""+rb.getServiceTaxAmount(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase(""+rb.getNetTestCharge(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase(""+rb.getBankName(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);

			c1 = new PdfPCell(new Phrase(""+ rb.getChqNo(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase(rb.getChqDateString(), TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table.addCell(c1);
			...
			if(null !=rb.getServiceTaxAmount()){
				totalServiceTaxAmount = totalServiceTaxAmount + rb.getServiceTaxAmount();
				
			}
	
			
			if(null !=rb.getNetTestCharge()){
				totalNetTestingCharge = totalNetTestingCharge + rb.getNetTestCharge();
				
			}
	
			
			if(null !=rb.getTestCharge()){
				totalAmount = totalAmount + rb.getTestCharge();
		...
		c1 = new PdfPCell(new Phrase("", TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase(""+totalServiceTaxAmount, TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table.addCell(c1);
		
		c1 = new PdfPCell(new Phrase(""+totalNetTestingCharge, TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table.addCell(c1);
		...
		c1 = new PdfPCell(new Phrase(""+totalAmount, TIME_ROMAN_SMALL));
		c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table.addCell(c1);
