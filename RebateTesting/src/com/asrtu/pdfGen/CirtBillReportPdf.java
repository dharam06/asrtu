...
import com.asrtu.bean.InvoiceBean;
	...
	public class CirtBillReportPdf {
		...
		public static Document createPDF(String file, List<CirtBillBean> cirtBillBean) {
			...
			try {
				...
				document.add( Chunk.NEWLINE );
		        document.add( Chunk.NEWLINE );
				createTable(document, cirtBillBean);
				document.add( Chunk.NEWLINE );
		        document.add( Chunk.NEWLINE );
				document.add( Chunk.NEWLINE );
		        document.add( Chunk.NEWLINE );
	...
	private static void createFooter(Document document) throws DocumentException  {
		...
		private static void createTable(Document document, List<CirtBillBean> cirtBillBeanList) throws DocumentException {
			...
			c1 = new PdfPCell(new Phrase("CIRT Bill No", TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
				
			c1 = new PdfPCell(new Phrase("CIRT Bill Date", TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase("CIRT Bill Amount", TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			
			c1 = new PdfPCell(new Phrase("CIRT Test Charge", TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
				
			c1 = new PdfPCell(new Phrase("ASRTU Ref No", TIME_ROMAN_SMALL));
			c1.setHorizontalAlignment(Element.ALIGN_CENTER);
			table.addCell(c1);
			
			Iterator<CirtBillBean> itr = cirtBillBeanList.iterator();
			CirtBillBean rb = null;
			...
			for (int i=1; itr.hasNext(); i++){
				...
				c1 = new PdfPCell(new Phrase(rb.getBillNo(), TIME_ROMAN_SMALL));
				c1.setHorizontalAlignment(Element.ALIGN_CENTER);
				table.addCell(c1);


				c1 = new PdfPCell(new Phrase(rb.getBillDateString(), TIME_ROMAN_SMALL));
				c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(c1);
				
				c1 = new PdfPCell(new Phrase(""+rb.getBillAmount(), TIME_ROMAN_SMALL));
				c1.setHorizontalAlignment(Element.ALIGN_CENTER);
				table.addCell(c1);
				...
				c1 = new PdfPCell(new Phrase(""+rb.getAsrtRefNo(), TIME_ROMAN_SMALL));
				c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(c1);
