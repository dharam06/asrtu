		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/printmiscomparativereport.html" name="myForm" method="post"
						onsubmit="return validateform()" class="registerLarge"  autocomplete="off">
						<fieldset class="row1">
							<legend>MIS Comparative Report</legend>
...
<p>
								<label>RC Cell Code </label> <input type="text"
									name="rcCellCode" id="rcCellCodeId"/> 
	</p>
