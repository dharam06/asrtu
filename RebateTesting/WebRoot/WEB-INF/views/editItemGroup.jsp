...
<h3 align="center" style="color: white;">Item Group Master</h3>
<form action="/rebatetest/saveItmGrop.html" method="post">
<table align="center">
<tr>
<td align="right" width="50%"><label style="font-size: 30px">S.No. </label></td><td width="1%">&nbsp;</td><td width="49%"><input type="text" name="sno"  value="${itemGroup.sno}" width="50" style="color: black; background: lime;"></td>
</tr>
<tr>
<td align="right" width="50%">Item Group Code</td><td width="1%">&nbsp;</td><td width="49%"><input type="text" name="itemGroupCode"  value="${itemGroup.itemGroupCode}" width="50" style="color: black;"></td>
</tr>
<tr>
<td align="right" width="50%">Item Group Name</td><td width="1%">&nbsp;</td><td width="49%"><input type="text"  name="itemGroupName" value="${itemGroup.itemGroupName}" width="50" style="color: black;"></td>
</tr>

<tr>
<td>&nbsp;</td><td width="1%">&nbsp;</td><td><input type="submit" value="Save" style="width: 60px;height: 30px;color: orange;">
...
<a href="editItemBack.html"  style="text-decoration: none;color: black;background: yellow;"><input type="button"  style="background: yellow; border: none"> Back</a>
</td>
</tr>
</table>
</form>
	...
	<table align="center" border="1">
		...
		<c:forEach items="${itemGroups}" var="item">
			<tr>
				...
				<td align="center"><a href="editItemGroup.html?sno=${item.sno}" style="color: white;">Edit</a> | <a href="deleteItemGroup.html?sno=${item.sno}" style="color: white;">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
