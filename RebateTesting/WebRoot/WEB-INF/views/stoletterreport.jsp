		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/printstoletterreport.html" name="myForm" method="post"
						 class="registerLarge"  autocomplete="off">
						<fieldset class="row1">
							<legend>STO Issue Generate Letters</legend>
...
<p>
								...
								<button type="submit" id="submit"
									class="btn btn-blue btn-effect" onkeyup="javascript:validateform();">Search</button>
