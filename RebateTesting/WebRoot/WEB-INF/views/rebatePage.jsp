				...
				<div class="overlay">
					<div class="container">
						...
						<div class="sec-title text-center white wow animated fadeInDown">
							...
							<div class="sec-title text-center white wow animated fadeInDown">
				<h4>
	<span style="font-size:200%;color:yellow;" >&#x2730;</span><a href="stu.html" style="color: white;">Stu Master Form</a>
<span style="font-size:200%;color:yellow;margin-left: 2.5em">&#x2730;</span><a href="Quarter.html" style="color: white;">Quarter Entry Form</a>
<span style="font-size:200%;color:yellow;margin-left:2.5em ">&#x2730;</span><a href="tax.html" style="color: white;">Tax Entry Form</a>
</h4>
								
								<h4>
								<span style="font-size:200%;color:yellow;margin-left: 3.5em">&#x2730;</span><a href="rebateform.html" style="color: white;">Rebate Form</a>
								<span style="font-size:200%;color:yellow;margin-left: 2.5em">&#x2730;</span><a href="rctrc.html" style="color: white;">RC-TRC Form</a>
								</h4>
