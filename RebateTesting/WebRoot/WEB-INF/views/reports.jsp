		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<p>
					<a href="stuDownloadPdf.html"
							class="btn btn-blue btn-effect">STU Master Report PDF</a></p>
							
							<p>
					<a href="bankreport.html"
							class="btn btn-blue btn-effect">Bank Report</a></p>
							
							<p>
					<a href="bankdetailreport.html"
							class="btn btn-blue btn-effect">Bank Detail Report</a></p>
							
							
							<p>
					<a href="invoicestatementreport.html"
							class="btn btn-blue btn-effect">Statement of Invoices</a></p>
							
											<p>
					<a href="miscomparativereport.html"
							class="btn btn-blue btn-effect">MIS Comparative Report</a></p>
												
									<p>
					<a href="misstuvendorreport.html"
							class="btn btn-blue btn-effect">MIS STU -Vendor Comparative for  Analysis purpose</a></p>
												
									<p>
					<a href="misyearlyreport.html"
							class="btn btn-blue btn-effect">MIS Yearly comparative Analysis</a></p>
