			...
			<div class="container">
				<div class="row">
					...
					<div class="sec-title text-center white wow animated fadeInDown">
						...
						<h2 align="center">List Quarter Entry</h2>
						...
						<c:if test="${!empty quarters }">
							<div class="table-responsive">
								<table
									...
									<c:forEach items="${quarters}" var="quarter" varStatus="status">
										<tr class="${status.count % 2 == 0 ? 'even' : 'odd'}"
										${status.count % 2 == 0 ? 'even' : 'odd'}>
											<td><c:out value="${status.count}" /></td>
											<td><c:out value="${quarter.quarter}" /></td>
											<td><c:out value="${quarter.qFromString}" /></td>
											<td><c:out value="${quarter.qtDateString}" /></td>
											<td align="center"><a
												href="editQuarter.html?slNo=${quarter.slNo}"><strong>Edit</strong></a> | <a
												href="deleteQuarter.html?slNo=${quarter.slNo}"><samp>Delete</samp></a></td>
										</tr>
									</c:forEach>
								</table>
							</div>
