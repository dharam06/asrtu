...
<body id="body">
	...
	<legend> Vendor GST Number list</legend>							

<c:if test="${not empty vendorgstList}">


<table class="table table-dark table-condensed  table-bordered no-margin" align="center">

<tr class="info"><td>SNo.</td><td>ID</td><td>GSTN No</td><td>Type</td><td>Cont Person</td><td>Cont No</td><td>Address1</td><td>Email</td><td>EDIT</td><!-- <td>DELETE</td> --></tr>
</label>

<c:forEach var="gst" items="${vendorgstList}" varStatus="loopCounter" >
<tr><td><c:out value="${loopCounter.count}"/></td><td><c:out value="${gst.id}"/></td><td><c:out value="${gst.gstNumber}"/></td><td><c:out value="${gst.vendorType}"/></td><td><c:out value="${gst.contactPerson}"/></td><td><c:out value="${gst.firstContact}"/></td><td><c:out value="${gst.address1}"/></td><td><c:out value="${gst.email}"/></td><td><a href="editVendorGst.html?id=${gst.id}"><samp>EDIT</samp></a></td><%-- <td><a href="deleteVendorGst.html?id=${gst.id}"><samp>Delete</samp></a></td> --%></tr>
</c:forEach>
	...
	<legend>Add New Vendor GST Number</legend>
<table class="table table-condensed   table-bordered no-margin" align="center">

<tr><td><label>GSTN No</label> <input type="text" name="gstNumber" id="gstNumberId"/> </td>
<td><label>TYPE</label>   
...
<td><label>Contact Person </label>  <input type="text" name="contactPerson" id="contactPersonId"/> </td>
...
<tr>
<td><label>Address1</label>   <input type="text" name="address1"  id="address1Id"/> </td>
<td><label>Address2</label>   <input type="text" name="address2"  id="address2Id"/> </td>
<td><label>Address3</label>   <input type="text" name="address3"  id="address3Id"/> </td>
<td><label>Pin Code</label>   <input type="text" name="pinCode"  id="pinCodeId"/> </td>


<td><label>Email</label>   <input type="text" name="email"  id="emailId"/> </td>
