		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/printstuinformationledger.html" name="myForm" method="post"
						onsubmit="return validateform()" class="registerLarge"  autocomplete="off">
						<fieldset class="row1">
							<legend>STU Information Ledger Report</legend>
...
<p>
								<label>Transaction From Date </label> <input type="text"
									name="transactionDateFrom" class="datepicker" id="transactionDateFromId"/> 
									
									<label>Transaction To Date </label> <input type="text" name="transactionDateTo"
									class="datepicker" id="transactionDateToId" />
</p>

									<p>
									<label>STU Name</label>
									<select name="stuName" id="stuID">
...
<p>
								<label>Only Contract plus three months and last contract </label> 
								
								<input type="checkbox"
									name="alternative" id="alternativeId" value="true"/> 
	</p>
