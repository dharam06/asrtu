...
<script type="text/javascript">
	function populateItemGroupName() {
		...
		AjaxHelper.getItemGroupByVendorID(vendorId,
				populateItemGroupNameCallback);
	}
	...
	function populateGstnumber() {
		...
		AjaxHelper.getGstnumberByVendorID(vendorId, populateGstnumberCallback);
	}

	function populateGstnumberCallback(data) {

		//window.alert("Data  "+data);    

		document.getElementById("gstnumberId").innerHTML = data;
		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/saveInvoice.html" name="myForm"
						method="post" onsubmit="return validateform()"
						class="registerLarge" autocomplete="off">
						<fieldset class="row1">
							<legend>Invoice Generation </legend>
							<p>
								<label>Invoice Date </label> <input type="text"
									id="datepickerto" name="invoiceDate" class="datepicker" />
							...
							<p>
								<label>Vendor Name</label> <select name="vendorCode"
									data-placeholder="--Please select----" class="chosen-select"
									id="vendorId" onchange="populateItemGroupName(); populateGstnumber();">
									<!-- populateItemGroupName(); -->
							...
							<p>
								<label>GST Number </label> <select name="gstId"
									id="gstnumberId">
							...
							<p>
								...
								<label>Quarter From Date </label> <input type="text"
									...
									id="quarterFromDateId" /> 
									
									<label>Quarter
									To Date </label> <input type="text" name="quarterToDate"
									class="datepicker" id="quarterToDate" />
</p>
<p>
...
<p>
								<label>Amount</label> <input type="text"
									name="rebateOutstanding" id="rebateOutstandingId" /> <br />
								<br />
							</p>
							<div>
