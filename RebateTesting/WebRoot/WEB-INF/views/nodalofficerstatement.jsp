		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/printnodalofficerstatement.html" name="myForm" method="post"
						onsubmit="return validateform()" class="registerLarge"  autocomplete="off">
						<fieldset class="row1">
							<legend>Nodal Officer statement</legend>
...
<p>
			...
			<p>			
								...
								<label>Nodal Officer </label> 
									<select name="nodalCode" id="nodalCodeID">
									
									<option value="0">--Please select--</option>
													
										<c:forEach items="${stuMaster }" var="stu">
											<option value="${stu.code }"><c:out
													value="${stu.modelName }" /></option>
...
<p>
								<label>Month Year </label> <input type="text"
