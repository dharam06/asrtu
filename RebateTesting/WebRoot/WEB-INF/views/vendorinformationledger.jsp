		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<form action="/rebatetest/printvendorinformationledger.html" name="myForm" method="post"
						onsubmit="return validateform()" class="registerLarge"  autocomplete="off">
						<fieldset class="row1">
							<legend>Vendor Information Report</legend>
